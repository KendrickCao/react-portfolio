            ...
            <Container style={{padding:"30vh 0"}}>
                <div>
                    ...
                    <div className="social-icon animate__animated animate__fadeInLeft animate__delay-1s">      
                        ...
                        <a title="Resume" rel="noreferrer" target="_blank" href="https://docs.google.com/document/d/1FD15aMrSRAvsK0zhQgegQYhn5vbxbI7u4GO3--VI_I8/edit?usp=sharing"><FaFileAlt className="social-icon-svg"style={{ fill: "url(#color-gradient)" }}/></a>
                    </div>
                    </Fade>
                </div>
